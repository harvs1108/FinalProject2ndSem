...
Public Class Form2
    ...
    Private Sub suemail_TextChanged(sender As Object, e As EventArgs) Handles suemail.TextChanged
        If Not Regex.IsMatch(suemail.Text, "^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$") Then
            emailValidationLabel.Text = "Invalid email format"
            emailValidationLabel.ForeColor = Color.Red
        Else
            emailValidationLabel.Text = "Valid email"
    ...
    Private Sub sucontact_TextChanged(sender As Object, e As EventArgs) Handles sucontact.TextChanged
        If Not Regex.IsMatch(sucontact.Text, "^[0-9]{11}$") Then
            contactValidationLabel.Text = "Contact number must be 11 digits"
            contactValidationLabel.ForeColor = Color.Red
        Else
            contactValidationLabel.Text = "Valid contact number"
            contactValidationLabel.ForeColor = Color.Green
        End If
    End Sub
