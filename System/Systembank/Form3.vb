    ...
    Private Sub btndeposit_Click(sender As Object, e As EventArgs) Handles btndeposit.Click
        If IsNumeric(txtamount.Text) AndAlso Val(txtamount.Text) > 0 Then
            ...
            If amount > 50000 Then
                MessageBox.Show("Maximum deposit limit per transaction is ₱50,000.", "Limit Exceeded")
                Exit Sub
            End If
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnwithdraw.Click
        If IsNumeric(txtamount.Text) AndAlso Val(txtamount.Text) > 0 Then
            ...
            If amount > 30000 Then
                MessageBox.Show("Maximum withdraw limit per transaction is ₱30,000.", "Limit Exceeded")
                Exit Sub
            End If
